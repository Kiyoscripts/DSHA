...
final class StartupRecoveryLayout {
    ...
    StartupRecoveryLayout(Context context,String reason,Runnable back){
        ...
        View backRow=action(content,t(com.deepseekharness.app.util.UiText.text("返回"),"Back"),R.drawable.ic_recovery_right,back,false);
        ...
        TextView title=label(titleBlock,t(com.deepseekharness.app.util.UiText.text("启动恢复"),"Startup recovery"),24,R.color.text);title.setTypeface(null,android.graphics.Typeface.BOLD);
    ...
    View action(LinearLayout parent,String label,int resource,Runnable click,boolean chevron){
        ...
        row.setBackgroundResource(R.drawable.bg_recovery_action);row.setFocusable(true);row.setContentDescription(com.deepseekharness.app.util.UiText.text(label));row.setOnClickListener(v->click.run());
        ...
        TextView text=new TextView(context);text.setText(com.deepseekharness.app.util.UiText.text(label));text.setTextSize(15);text.setIncludeFontPadding(false);text.setGravity(Gravity.CENTER_VERTICAL);
